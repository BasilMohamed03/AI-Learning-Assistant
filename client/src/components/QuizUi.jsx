...
export const QuizUi = ({ hidden, ...props }) => {
  ...
  useEffect(() => {
    // Trigger an action when a new message is received, if needed
    // For example, you may want to scroll to the newly added quiz questions
  }, [message]);
        ...
        <div className="page mx-auto bg-gray-800 bg-opacity-75 w-8/5 h-11/5 p-4 shadow-md border-2 border-black ">
          ...
          <div className="print-button text-center mt-4">
            ...
            <button
              ...
              className="mt-4 bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-md mx-11 px-7 py-3 print:hidden"
            >
              Continue
            </button>
          </div>
