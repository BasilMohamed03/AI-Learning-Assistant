  ...
  render() {
    ...
    return (
      <div className="show-details-button shadow-lg">
        <div className="flex flex-col text-left w-full h-full rounded-b-lg  bg-lightCard dark:bg-slate-800 shadow-lg py-2">
          <div className="flex flex-row text-xs p-2 px-4 justify-between">
            ...
            {/* <div> */}
              ...
              {/* <button className="flex justify-center items-center  border-lightCard dark:border-slate-800  w-8 h-8 border-2 rounded-full ml-2 hover:border-white">
            ...
            <button
              ...
              className="flex justify-center items-center  border-lightCard dark:border-slate-800  w-8 h-8 border-2 rounded-full hover:border-white"
            >
          ...
          {/* <div className="flex flex-row text-sm font-netflixsansregular text-left p-2 px-4 items-center flex-wrap gap-x-2">
            ...
            {movie?.maturitynumber ? (
              <span className="px-1.5 border-slate-400 dark:border-slate-800 text-[13px] border-[1px]">
                {movie.maturitynumber}+
              </span>
            ) : null}
            {movie?.duration ? (
